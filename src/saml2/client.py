...
#            fil.close()
    ...
    def construct_logout_request(self, subject_id, session_index_val, destination,
    ...
    def global_logout(self, subject_id, session_index,  return_to="/", reason="", expire=None,
                          sign=None, log=None):
        ...
        return self._logout(subject_id, session_index, entity_ids, reason, expire, 
                            sign, log, return_to)
        
    def _logout(self, subject_id, session_index, entity_ids, reason, expire, 
                sign=None, log=None, return_to="/"):
        print " logout return_to :::",return_to
        # check time
        ...
        for entity_id in entity_ids:
            ...
            for binding in [BINDING_SOAP, BINDING_HTTP_REDIRECT,
                            BINDING_HTTP_POST]:
                ...
                request = self.construct_logout_request(subject_id, session_index, destination,
                ...
                if binding == BINDING_SOAP:
                    ...
                    print " logout rstate :::",rstate,"return ::",return_to
                    ...
                    if binding == BINDING_HTTP_POST:
                        print "BINDING_HTTP_POST"
                        (head, body) = http_post_message(request, 
                                                            destination, 
                                                            rstate)
                        code = "200 OK"
                    else:
                        print "REDIRECT",binding
    ...
    def handle_logout_response(self, response, log):
        ...
        if status["entity_ids"] == [issuer]: # done
            ...
            return 0, "200 Ok", [("Content-type","text/html")], [status["return_to"]]
        else:
